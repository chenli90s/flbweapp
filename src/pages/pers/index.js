    ...
    if (role === 2) {
      view = (
        <i-cell-group>
          ...
          <i-cell title='我的订单' is-link url='/pages/admin/myorder'/>
          <i-cell title='历史订单' is-link url='/pages/admin/history'/>
          <i-cell title='手机号修改' is-link url='/pages/admin/modify'/>
        </i-cell-group>
      )
    }
    ...
    if (role === 3) {
      view = (
        <i-cell-group>
          ...
          <i-cell title='管理' is-link url='/pages/superadmin/manageuser'/>
          {/*<i-cell title='商品管理' is-link url='/pages/superadmin/manageprud'></i-cell>*/}
          <i-cell title='历史订单' is-link url='/pages/superadmin/historyorder'/>
        </i-cell-group>
      )
    }
